            ...
            <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <form class="form w-100" method="post" action="{{ route('password.email') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
                                ...
                                <!--begin::Link-->
                                <a href="{{ route('admin.login.form') }}" class="link-primary" data-kt-translate="sign-in-forgot-password">
                                    Login
                                </a>
                                <!--end::Link-->
                            </div>
                ...
                <div class="m-0">
                    ...
                    <button class="btn btn-flex btn-link rotate" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px">
                        <img  data-kt-element="current-lang-flag" class="w-25px h-25px rounded-circle me-3" src="../../../assets/admin/media/flags/united-states.svg" alt=""/>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4" data-kt-menu="true" id="kt_auth_lang_menu">
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="English">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="../../../assets/admin/media/flags/united-states.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="../../../assets/admin/media/flags/spain.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="../../../assets/admin/media/flags/germany.svg" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ asset('assets/admin/media/flags/japan.svg') }}" alt=""/>
                                </span>
