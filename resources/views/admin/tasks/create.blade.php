            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="title" class="form-control form-control-lg form-control-solid" placeholder="Görev başlığını giriniz" value="{{ old('title') }}" required />
                    </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="duration" class="form-control form-control-lg form-control-solid" placeholder="Örn: 3" value="{{ old('duration') }}" required />
                    </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="amount" class="form-control form-control-lg form-control-solid" placeholder="Örn: 200" value="{{ old('amount') }}" required />
                    </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="reward" class="form-control form-control-lg form-control-solid" placeholder="Örn: 210" value="{{ old('reward') }}" />
                    </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="number" name="score" class="form-control form-control-lg form-control-solid" placeholder="Puan değerini giriniz" value="{{ old('score') }}" required />
                    </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <textarea name="description" class="form-control form-control-solid" rows="4" placeholder="Görev açıklaması..." required>{{ old('description') }}</textarea>
                    </div>
                </div>
                <!--end::Input group-->
