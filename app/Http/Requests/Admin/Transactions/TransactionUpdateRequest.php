...
class TransactionUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'withdrawal_receipt' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:10240'],
    ...
    public function messages(): array
    {
        return [
            ...
            'partial_payments.*.file.required' => 'Dosya zorunludur.',
            ...
            'file.file' => 'Lütfen geçerli bir dosya yükleyin.',
            'file.mimes' => 'Dosya yalnızca JPG, PNG veya PDF formatında olabilir.',
            'file.max' => 'Dosya boyutu maksimum 10 MB olabilir.',
